...
class UserServiceIf {
 public:
  ...
  virtual void addlist(const std::vector<User> & u) = 0;
...
typedef struct _UserService_addlist_args__isset {
  _UserService_addlist_args__isset() : u(false) {}
  bool u;
} _UserService_addlist_args__isset;

class UserService_addlist_args {
 public:

  UserService_addlist_args() {
  }

  virtual ~UserService_addlist_args() throw() {}

  std::vector<User>  u;

  _UserService_addlist_args__isset __isset;

  void __set_u(const std::vector<User> & val) {
    u = val;
  }

  bool operator == (const UserService_addlist_args & rhs) const
  {
    if (!(u == rhs.u))
      return false;
    return true;
  ...
  bool operator < (const UserService_addlist_args & ) const;
...
class UserService_addlist_pargs {
 public:


  virtual ~UserService_addlist_pargs() throw() {}
...
class UserService_addlist_result {
 public:

  UserService_addlist_result() {
  }

  virtual ~UserService_addlist_result() throw() {}


  bool operator == (const UserService_addlist_result & /* rhs */) const
  {
    return true;
  }
  bool operator != (const UserService_addlist_result &rhs) const {
  ...
  bool operator < (const UserService_addlist_result & ) const;
...
class UserService_addlist_presult {
 public:


  virtual ~UserService_addlist_presult() throw() {}
...
class UserServiceClient : virtual public UserServiceIf {
 public:
  ...
  void recv_add();
  void addlist(const std::vector<User> & u);
  void send_addlist(const std::vector<User> & u);
  void recv_addlist();
  void get(User& _return, const std::string& uid);
...
class UserServiceProcessor : virtual public ::apache::thrift::TProcessor {
 ...
 private:
  ...
  void process_addlist(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  UserServiceProcessor(boost::shared_ptr<UserServiceIf> iface) :
    ...
    processMap_["addlist"] = &UserServiceProcessor::process_addlist;
